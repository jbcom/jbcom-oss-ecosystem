...
export const MCP_ENV_VARS = {
  ...
  github: { name: "GITHUB_TOKEN", sources: ["COPILOT_MCP_GITHUB_TOKEN", "GITHUB_JBCOM_TOKEN", "GITHUB_TOKEN"] },
  context7: { name: "CONTEXT7_API_KEY", sources: ["COPILOT_MCP_CONTEXT7_API_KEY", "CONTEXT7_API_KEY"], optional: true },
} as const;

/** @deprecated Use getMCPConfig() and resolveToken() instead */
export const mcpCredentials = {
  get cursorApiKey() { return resolveToken(getMCPConfig().cursor ?? {}); },
  get githubToken() { return resolveToken(getMCPConfig().github ?? {}); },
  get context7ApiKey() { return resolveToken(getMCPConfig().context7 ?? {}); },
};
